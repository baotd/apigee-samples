...
curl -X POST "https://34.144.192.207.nip.io/v2/samples/llm-token-limits/v1/projects/retail-agent-demo/locations/us-central1/publishers/google/models/gemini-2.5-flash:generateContent" \
